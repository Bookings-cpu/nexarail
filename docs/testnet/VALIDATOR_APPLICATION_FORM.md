...
| Field | Your Response |
|---|---|
| Operator Name | NodeSafe |
| Organisation (if any) | |
| Country / Jurisdiction | Vietnam |
| Contact Email | cryptogemfunds@gmail.com |
| Discord Handle | @cryptogemfunds |
| Telegram Handle | @cryptogemfunds |
| GitHub Handle | cryptogemfunds |
| Website (optional) | https://explorer.nodesafe-app.xyz/ |

## Validator Information

| Field | Your Response |
|---|---|
| Validator Moniker | NodeSafe |
...
| Field | Your Response |
|---|---|
| Hosting Provider | Homelab, Hetzner and Netcup |
| Operating System | Ubuntu 22.04 & 24.04|
| CPU Cores | 8-32 vCPU |
| RAM (GB) | 16 - 256 GB |
| Disk Size & Type | 0.5 - 4 TB NVME|
| Network Speed | 0.3 - 1 Gbps|
| Static IP Available? | Yes |
| Geographic Region | Multiple regions EU/ASIA |
| Redundant Power? | Yes |
| Redundant Network? | Yes |
| Monitoring Setup | Monitoring with Prometheus, Grafana, RPC health checks, block height monitoring and alerting. My explorer: https://explorer.nodesafe-app.xyz/ |
| Backup / Snapshot Strategy | Firewall rules are set up. The local machine storing the keys has a licensed Symantec EndPoint installed. Offline mnemonic backup. |

## Experience

| Field | Your Response |
|---|---|
| Years Running Validators | 3+ |
